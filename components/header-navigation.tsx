...
export function HeaderNavigation() {
  ...
  return (
    <header
      className="border-b border-amber-100 sticky top-0 z-50"
      style={{ backgroundColor: " #0c271cff" }}
    >
      {" "}
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <div className="flex items-center space-x-3">
              <div
                className="px-3 py-2 rounded font-bold text-xl shadow-sm"
                style={{ backgroundColor: "#ddc01bff", color: "1C3B2F " }}
              >
                HT
              </div>
              <div className="hidden sm:block">
                <div className="text-lg font-bold" style={{ color: "#ddc01bff" }}>
                  HEMTOUCH
                </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <button
              ...
              className={`font-medium transition-colors text-[#ddc01bff] hover:text-[#FFA500] ${
                activeSection === "booking" ? "text-[#FFA500]" : ""
              }`}
            >
              Đặt Phòng
            </button>
            <button
              ...
              className={`font-medium transition-colors text-[#ddc01bff] hover:text-[#FFA500] ${
                activeSection === "business" ? "text-[#FFA500]" : ""
              }`}
            >
              Doanh Nghiệp
            </button>
          ...
          <div className="hidden md:flex items-center space-x-4">
              ...
              <DropdownMenuTrigger asChild>
                ...
                >
                  <span className="w-5 h-4 bg-red-500 rounded-sm flex items-center justify-center">
                    <span className="text-[#ddc01bff] text-xs">★</span>
                  </span>
                  <span className="font-medium text-[#ddc01bff]">VIE</span>
                  <ChevronDown className="w-4 h-4 text-[#ddc01bff]" />
                </Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent>
            ...
            <Button
              ...
              className="p-2"
            >
              <Menu className="w-6 h-6 text-[#ddc01bff]" />
            </Button>
          </div>
              ...
              <div className="border-t border-gray-700 pt-6 space-y-4">
                ...
                <div className="border-t border-gray-700 pt-4">
                  <div className="flex items-center justify-center space-x-6">
                    ...
                    <a
                      href="mailto:info@mivillage.com"
                      className="text-gray-400 hover:text-white transition-colors"
                    >
                      <svg
                        className="w-5 h-5"
